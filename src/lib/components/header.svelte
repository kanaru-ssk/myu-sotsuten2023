...
<header class="bg-secondary fixed top-0 z-10 h-16 w-full md:h-20">
  <input
    type="checkbox"
  ...
  <nav
    class="bg-secondary pointer-events-none -translate-y-1/2 scale-y-0 pb-5 text-right text-lg font-bold text-white duration-500 peer-checked:pointer-events-auto peer-checked:translate-y-0 peer-checked:scale-y-100 md:pointer-events-auto md:h-full md:transform-none md:pb-0 md:pr-5"
  >
    <ul
